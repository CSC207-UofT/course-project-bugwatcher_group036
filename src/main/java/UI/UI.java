...
public class UI {
    ...
    private void initGame() {
        ...
        ControllerBuilder unoBuilder = new ControllerBuilder(Integer.valueOf(num));
        newGameController = unoBuilder.buildUnoController();
        newGameController.getEachRound().setUI(this);//bind the ui
        vars = new ControllerVariables(newGameController.getPlayerManager().getPlayerNum());
    ...
    public void displayCard(Card lastCard, ArrayList<Card> handCard,
        ...
        card.setText(lastCard.toString());
        cardHas.removeAll();
