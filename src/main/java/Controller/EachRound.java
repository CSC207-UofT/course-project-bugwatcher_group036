    ...
    public boolean drawCardWhenNoCardToPlay(ArrayList<Card> currentCardsPlayerCanPlay, int currentPlayerIndex,
        ...
        if (currentCardsPlayerCanPlay.isEmpty()) {
            ...
            if (!cardManager.whetherNull(c)) {
                ...
                drawCard = true;
                JOptionPane.showMessageDialog(null, "You cannot play a card! You need to draw one more card."+"The card you drew is " + c);
            }
        }
        return drawCard;
    }
    ...
    public Card letPlayerPlayCard(ArrayList<Card> currentCardsPlayerCanPlay,
        ...
        do {
            ...
            if (ui != null) {
                ...
                cardToPlayID = (String) JOptionPane.showInputDialog(null, "OK to play card or cancel to draw", playerManager.getPlayers()[currentPlayerIndex] + " Choose", JOptionPane.INFORMATION_MESSAGE, null, array, null);
    ...
    public Card operationsForPlayer(ControllerVariables vars, Card cardToPlay,
        ...
        if (!getCurrentCardsPlayerCanPlayer(vars).isEmpty()) {
            ...
            if (!drawCardToPlay) {
                ...
                if (ui != null) {
                    ui.displayCard(playerManager.getLastCard(),playerManager.getHandCard(vars.getCurrentPlayerIndex()),cardManager.getDeck().getUnusedCardDeck());
                }
