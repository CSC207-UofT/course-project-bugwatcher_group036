...
//    }
//
//    private void OperationsWhenNoCardToPlay(ControllerVariables vars, ArrayList<Card> currentCardsPlayerCanPlay) {
//        if (vars.getPlus() > 0) {
...
//    }
//
//    private void winOrNotInThisRound(ControllerVariables vars) {
...
//    }
//
//    private Card operationsForPlayer(ControllerVariables vars, Card cardToPlay, ArrayList<Card> currentCardsPlayerCanPlay) {
//        if (currentCardsPlayerCanPlay.isEmpty()) {
...
//    }
//
//    private void effectsAfterPunishOrPlayCard(ControllerVariables vars, Card cardToPlay) {
